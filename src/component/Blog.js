...
export default function Blog(){
    ...
    async function handleSubmit(e){
        ...
        setBlogs([{title: formData.title,content:formData.content}, ...myblogs]);
    ...
    async function removeBlog(id){
        ...
        // setBlogs( myblogs.filter((blog,index)=> index !== i));
    ...
    return(
        ...
        {myblogs.map((blog,i) => (
            <div className="blog" key={i}>
                ...
                <hr/>
                <p>{blog.content}</p>
                <button onClick={()=>removeBlog(blog.id)} className="deleteBtn">Delete</button>
